							...
							if (a.stickySidebar.is(":visible")) {
								...
								if (d >= a.sidebar.offset().top + (a.paddingTop - a.options.additionalMarginTop)) {
									...
									s =
										(k || y != h) && (k || y != c - a.stickySidebar.outerHeight())
											? d + y - a.sidebar.offset().top - a.paddingTop <= t.additionalMarginTop
												? "static"
												: "absolute"
											: "fixed";
								}
								if ("fixed" == s) {
									...
									"absolute" != a.stickySidebar.css("position") &&
										...
										(x.transform =
											"translateY(" +
											(d + y - a.sidebar.offset().top - a.stickySidebarPaddingTop - a.stickySidebarPaddingBottom) +
											"px)"),
										(x.top = "0px")),
...
$(document).ready(function (e) {
	...
	$(".wysiwyg")
		.find("h2:not(.see_also_heading), h3:not(.see_also_heading), h4:not(.see_also_heading), h5:not(.see_also_heading)")
		.hover(
			function () {
