...
!(function (e, t, n) {
	...
	function a(e) {
		...
		Modernizr._config.enableClasses &&
			((t += " " + n + e.join(" " + n)), S ? (b.className.baseVal = t) : (b.className = t));
	}
	function i() {
	...
	function l(e, n, r, o) {
		...
		return (
			...
			p.fake &&
				...
				b.appendChild(p)),
			(l = n(d, e)),
			p.fake ? (p.parentNode.removeChild(p), (b.style.overflow = u), b.offsetHeight) : d.parentNode.removeChild(d),
			!!l
		);
	}
	function c(e, t) {
	...
	function h(e, t, o, a) {
		...
		for (var f, d, p, h, v, g = ["modernizr", "tspan", "samp"]; !z.style && g.length; )
			(f = !0), (z.modElem = i(g.shift())), (z.style = z.modElem.style);
		for (p = e.length, d = 0; p > d; d++)
			if (((h = e[d]), (v = z.style[h]), c(h, "-") && (h = u(h)), z.style[h] !== n)) {
	...
	var _ = "Moz O ms Webkit",
		N = E._config.usePrefixes ? _.split(" ") : [];
	E._cssomPrefixes = N;
	var T = E._config.usePrefixes ? _.toLowerCase().split(" ") : [];
	E._domPrefixes = T;
