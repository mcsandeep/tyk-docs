var doNav = function () {
	...
	if (!prevPage) {
		...
		$("#previousArticle")
			.html("<span>PREVIOUS</span>" + prevPage.text)
			.attr("href", prevPage.link);
	}
	...
	if (!nextPage) {
		...
		$("#nextArticle")
			.html("<span>NEXT</span>" + nextPage.text)
			.attr("href", nextPage.link);
	}
	...
	$(".suggest-edit").on("click", function (e) {
		...
		if ($(".active").hasClass("st-open")) {
			window.open(
				"https://github.com/TykTechnologies/tyk-docs/tree/master/tyk-docs/content/" +
					githubCustomLink +
					"/" +
					docName +
					".md",
			...
			if (currentPageGH == "/docs") {
				window.open(
					"https://github.com/TykTechnologies/tyk-docs/tree/master/tyk-docs/content/documentation.md",
					"_blank",
				);
			} else {
				window.open(
			...
			window.open(
				"https://github.com/TykTechnologies/tyk-docs/tree/master/tyk-docs/content" + githubCustomLink + "." + extension,
				"_blank",
			);
		}
	});
