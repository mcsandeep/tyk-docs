	...
	(function () {
		(function () {
			this.Turbolinks = {
				supported: (function () {
					return (
						null != window.history.pushState && null != window.requestAnimationFrame && null != window.addEventListener
					);
				})(),
				visit: function (e, r) {
		...
		(function () {
			...
			(t.copyObject = function (t) {
				...
				(r = (function () {
					...
					return (
						(t = document.documentElement),
						null !=
						(e = null != (r = null != (n = t.matchesSelector) ? n : t.webkitMatchesSelector) ? r : t.msMatchesSelector)
							? e
					...
					function t(t) {
						...
						null == t && (t = ""),
							...
							2 > e
								...
								: ((this.requestURL = this.absoluteURL.slice(0, -e)), (this.anchor = r.hash.slice(1)));
					}
					var e, r, n, o;
					return (
						(t.wrap = function (t) {
						...
						(t.prototype.getPath = function () {
							var t, e;
							return null != (t = null != (e = this.absoluteURL.match(/\/\/[^\/]*(\/[^?;]*)/)) ? e[1] : void 0)
								? t
								: "/";
						}),
				...
				t.HttpRequest = (function () {
					...
					return (
						...
						(r.prototype.send = function () {
							...
							return this.xhr && !this.sent
								? (this.notifyApplicationBeforeRequestStart(),
									...
									this.xhr.send(),
									(this.sent = !0),
									"function" == typeof (t = this.delegate).requestStarted ? t.requestStarted() : void 0)
								: void 0;
						}),
						...
						(r.prototype.endRequest = function (t) {
							return this.xhr
								? (this.notifyApplicationAfterRequestEnd(), null != t && t.call(this), this.destroy())
								: void 0;
						}),
				...
				t.History = (function () {
					...
					return (
						...
						(r.prototype.onPopState = function (e) {
							var r, n, o, i;
							return this.shouldHandlePopState() && (i = null != (n = e.state) ? n.turbolinks : void 0)
								? ((r = t.Location.wrap(window.location)),
									(o = i.restorationIdentifier),
									this.delegate.historyPoppedToLocationWithRestorationIdentifier(r, o))
								: void 0;
						}),
			...
			function () {
				t.Snapshot = (function () {
					function e(t) {
						...
						(r = t.head),
							(e = t.body),
							(this.head = null != r ? r : document.createElement("head")),
					...
					return (
						...
						(e.prototype.getSetting = function (t) {
							var e, r;
							return (
								(r = this.head.querySelectorAll("meta[name='turbolinks-" + t + "']")),
								(e = r[r.length - 1]),
					...
					return (
						...
						(t.prototype.createScriptElement = function (t) {
							...
							return "false" === t.getAttribute("data-turbolinks-eval")
								? t
								: ((e = document.createElement("script")), (e.textContent = t.textContent), r(e, t), e);
						}),
						(r = function (t, e) {
							var r, n, o, i, s, a, u;
			...
			function () {
				t.HeadDetails = (function () {
					function t(t) {
						var e, r, i, s, a, u, l;
						for (this.element = t, this.elements = {}, l = this.element.childNodes, s = 0, u = l.length; u > s; s++)
							(i = l[s]),
								i.nodeType === Node.ELEMENT_NODE &&
									((a = i.outerHTML),
									(r = null != (e = this.elements)[a] ? e[a] : (e[a] = { type: o(i), tracked: n(i), elements: [] })),
									r.elements.push(i));
					}
					var e, r, n, o;
					return (
						...
						(t.prototype.getProvisionalElements = function () {
							...
							for (e in n)
								(o = n[e]),
									...
									(i = o.tracked),
									(t = o.elements),
									null != s || i ? t.length > 1 && r.push.apply(r, t.slice(1)) : r.push.apply(r, t);
							return r;
						}),
						(o = function (t) {
						...
						(r = function (t) {
							var e;
							return (
								(e = t.tagName.toLowerCase()), "style" === e || ("link" === e && "stylesheet" === t.getAttribute("rel"))
							);
						}),
						t
					);
				...
				t.SnapshotRenderer = (function (r) {
					...
					return (
						...
						(n.prototype.importBodyPermanentElements = function () {
							var t, e, r, n, o, i;
							for (n = this.getNewBodyPermanentElements(), i = [], e = 0, r = n.length; r > e; e++)
								(o = n[e]),
						...
						(n.prototype.activateBodyScriptElements = function () {
							var t, e, r, n, o, i;
							for (n = this.getNewBodyScriptElements(), i = [], e = 0, r = n.length; r > e; e++)
					...
					return (
						...
						(e.prototype.render = function (t, e) {
							...
							return (
								...
								null != o ? this.renderSnapshot(o, e) : this.renderError(r, e)
							);
						}),
					...
					return (
						(r.prototype.start = function () {
							return "initialized" === this.state
								? (this.recordTimingMetric("visitStart"), (this.state = "started"), this.adapter.visitStarted(this))
								: void 0;
						}),
						(r.prototype.cancel = function () {
							var t;
							return "started" === this.state
								? (null != (t = this.request) && t.cancel(), this.cancelRender(), (this.state = "canceled"))
								: void 0;
						}),
						...
						(r.prototype.fail = function () {
							...
							return "started" === this.state
								? ((this.state = "failed"),
									"function" == typeof (t = this.adapter).visitFailed ? t.visitFailed(this) : void 0)
								: void 0;
						}),
						(r.prototype.changeHistory = function () {
							...
							return this.historyChanged
								? void 0
								: ((t = this.location.isEqualTo(this.referrer) ? "replace" : this.action),
									(e = n(t)),
						...
						(r.prototype.getCachedSnapshot = function () {
							var t;
							return !(t = this.controller.getCachedSnapshotForLocation(this.location)) ||
								(null != this.location.anchor && !t.hasAnchor(this.location.anchor)) ||
							...
							return (e = this.getCachedSnapshot())
								? ((t = this.shouldIssueRequest()),
									this.render(function () {
										...
										return (
											this.cacheSnapshot(),
											this.controller.render({ snapshot: e, isPreview: t }, this.performScroll),
											"function" == typeof (r = this.adapter).visitRendered && r.visitRendered(this),
						...
						(r.prototype.requestCompletedWithResponse = function (e, r) {
							return (
								(this.response = e),
								null != r && (this.redirectedToLocation = t.Location.wrap(r)),
						...
						(r.prototype.scrollToRestoredPosition = function () {
							var t, e;
							return (
								(t = null != (e = this.restorationData) ? e.scrollPosition : void 0),
				...
				t.Controller = (function () {
					...
					return (
						...
						(r.prototype.startVisitToLocationWithAction = function (e, r, n) {
							var o;
							return t.supported
								? ((o = this.getRestorationDataForIdentifier(n)), this.startVisit(e, r, { restorationData: o }))
								: (window.location = e);
						}),
						...
						(r.prototype.clickBubbled = function (t) {
							...
							return this.enabled &&
								...
								? (t.preventDefault(), (e = this.getActionForLink(r)), this.visit(n, { action: e }))
								: void 0;
						}),
						...
						(r.prototype.notifyApplicationAfterPageLoad = function (e) {
							return (
								null == e && (e = {}),
								t.dispatch("turbolinks:load", { data: { url: this.location.absoluteURL, timing: e } })
							);
						}),
						...
						(r.prototype.createVisit = function (e, r, n) {
							...
							return (
								...
								(u.restorationIdentifier = null != a ? a : t.uuid()),
								(u.restorationData = t.copyObject(s)),
								(u.historyChanged = o),
