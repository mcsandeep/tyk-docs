  ...
  "Data": [
    {
      ...
      "apply_policies": ["5ce4086ce845260001c1e1f5"],
      ...
      "portal_developer": {
        ...
        "org_id": "5cc03283d07e7f00019404b3",
        "keys": {
          "55b1ba47": ["5ce4086ce845260001c1e1f5"]
        },
        "subscriptions": {
...
**Note:** If you're using _Authentication Token_ as your _authentication mode_, the `RawKey` value is the actual API Key used to send authenticated requests.
...
**Note:** If you're using Basic _Basic Authentication_ as your _authentication mode_, the `RawKey` value is the username used to send authenticated requests.
