...
Please consult the Tyk Operator supporting documentation for an example of how to [enable basic authentication]({{< ref "/api-management/automations#set-up-tyk-classic-api-authentication#basic-authentication" >}}) with Tyk Operator.
