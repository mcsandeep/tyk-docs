...
{ ? ...
  ...
  : {
      ...
      "auth-C": { ... },
      "auth-D": { ... },
    }, security: [{ "auth-A": [], "auth-C": [] }, { "auth-B": [] }, { "auth-D": [] }] }
```
          ...
          "authentication":
            {
              ...
              "securitySchemes": { "auth-A": { "enabled": true, ... }, "auth-C": { "enabled": true, ... } },
            },
        } } }
```
