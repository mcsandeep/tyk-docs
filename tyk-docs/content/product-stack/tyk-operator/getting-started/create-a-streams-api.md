---
title: "Create a Streams API with Tyk Operator"
date: 2024-06-25
tags: ["Tyk Operator", "Kubernetes", "Create an API"]
description: "Create a Streams API"
---

This step-by-step tutorial will guide you through the process of creating a Tyk Streams API using Tyk Operator in your Kubernetes environment. Tyk Operator allows you to manage your APIs declaratively, utilizing the `TykStreamsApiDefinition` custom resource.

## Prerequisites
Before you begin, ensure you have the following:

1. A Kubernetes cluster with [kubectl](https://kubernetes.io/docs/reference/kubectl/) configured to interact with it.
2. [Tyk Operator v1.1+]({{<ref "tyk-stack/tyk-operator/installing-tyk-operator">}}) installed in your Kubernetes cluster.
...
4. A valid Tyk Streams API definition in JSON format.

## Step 1: Prepare the Tyk OAS API Definition
First, you need to have a complete Tyk Streams API definition file ready. This file will contain all the necessary configuration details for your API in OpenAPI Specification (OAS) format.
