...
|--------------------------------------|-----------|----------------|------------------------------------------------------------------------|-----------------------------------------------------------------|
| Detailed recording (in Log Browser)  | ✅        | v0.4.0         | Currently this feature is not documented. For further details please [contact us](https://tyk.io/contact)                                                                |                                                                 |
| Config Data                          | ✅        | v0.8.2         | -                                                                      | [Config Data]({{<ref "product-stack/tyk-gateway/middleware/virtual-endpoint-tyk-classic#tyk-operator">}}) |
| Context Variables                    | ✅        | v0.1           | Currently this feature is not documented. For further details please [contact us](https://tyk.io/contact)                                                                   |
...
| Internal API (not exposed by Gateway)| ✅        | v0.6.0         | Currently this feature is not documented. For further details please [contact us](https://tyk.io/contact)                                                                     |                                                                |
