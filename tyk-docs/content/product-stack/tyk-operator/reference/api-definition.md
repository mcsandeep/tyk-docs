...
| ----------------------- | ------- | -------------- | -------- | -------------------------------------------------------------------------------------------------------------- |
| HTTP                    | ✅      | v0.1           | -        | [HTTP Proxy]({{<ref "/api-management/automation#set-up-manifest-for-http#http-proxy">}})               |
| HTTPS                   | ✅      | v0.4           | -        | [HTTPS Proxy]({{<ref "/api-management/automation#set-up-manifest-for-http#https-proxy">}})             |
| TCP                     | ✅      | v0.1           | -        | [TCP Proxy]({{<ref "/api-management/automation#set-up-manifest-for-tcp">}})                            |
| TLS                     | ✅      | v0.1           | -        |                                                                                                                |
| GraphQL - Proxy         | ✅      | v0.1           | -        | [GraphQL Proxy]({{<ref "/api-management/automation#set-up-manifest-for-grapqhl">}})                    |
| Universal Data Graph v1 | ✅      | v0.1           | -        | [UDG v1 Proxy]({{<ref "/api-management/automation#set-up-manifest-for-udg#udg-v1-tyk-31-or-before">}}) |
| Universal Data Graph v2 | ✅      | v0.12          | -        | [UDG v2 Proxy]({{<ref "/api-management/automation#set-up-manifest-for-udg#udg-v2-tyk-32-and-above">}}) |
...
| ---------------- | --------- | -------------- | -------- | ---------------------------------------------------------------------------------------------------------------------- |
| Path-Based Proxy | ✅        | v0.1           | -        | [HTTP Proxy]({{<ref "/api-management/automation#set-up-manifest-for-http#http-proxy">}})                       |
| Host-Based Proxy | ✅        | v0.1           | -        | [HTTP Host-based Proxy]({{<ref "/api-management/automation#set-up-manifest-for-http#http-host-based-proxy">}}) |
| Target URL       | ✅        | v0.1           | -        | [HTTP Proxy]({{<ref "/api-management/automation#set-up-manifest-for-http#http-proxy">}})                       |
