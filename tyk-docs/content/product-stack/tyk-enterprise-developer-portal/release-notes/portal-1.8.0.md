...
2. _(Optional)_ Save a copy of the current default theme if there are changes that you want to keep.
...
5. _(Optional)_ Once the portal is operational again, you can download the correct default theme and apply any changes from the existing theme that was saved in step 2.
...
1. _(Optional)_ If you need to save changes to the existing default theme, downgrade to 1.6.0, start the portal and download the theme either via the UI or the admin APIs.
...
4. _(Optional)_ Once the portal is operational again, you can download the correct default theme and apply any changes from the existing theme that was saved in step 1.
