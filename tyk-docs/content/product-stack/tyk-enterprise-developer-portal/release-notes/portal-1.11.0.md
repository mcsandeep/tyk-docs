...
- [22 bugs fixed]({{< ref "/product-stack/tyk-enterprise-developer-portal/release-notes/portal-1.11.0.md#fixed" >}})
- [19 CVEs fixed]({{< ref "/product-stack/tyk-enterprise-developer-portal/release-notes/portal-1.11.0.md#fixed" >}})
...
- UI and API for themes soft delete.  
