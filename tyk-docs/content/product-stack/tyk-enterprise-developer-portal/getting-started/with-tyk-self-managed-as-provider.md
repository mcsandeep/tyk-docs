...
| Secret                   | The Secret can be fetched from the Tyk Self-Managed / Tyk analytics dashboard. The procedure is as follows: Go to the Tyk Dashboard. Navigate to _Users_. Select a user with the permissions you want to bring on to the portal. You can find the secret under _API Access Credentials. (Optional)_. You can find the organization id listed under _Organization ID_ if your use case requires this. Please note that the Portal will share the same permissions that the user selected to provide the secret.                                                                                                                                                                                                                                                                                                    |
