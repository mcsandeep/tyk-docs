...
tags:
  ["response transform", "body transform", "transform", "middleware", "per-endpoint", "Tyk Classic", "Tyk Classic API"]
---
...
Use the _save_ or _create_ buttons to save the changes and activate the Response Body Transform middleware.
