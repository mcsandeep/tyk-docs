...
global:
  components:
    ...
    # For further details, please refer to https://tyk.io/docs//api-management/automation#install-and-configure-tyk-operator/
    operator: false
```
