...
The input format is defined by showing how the reference time, defined to be _Mon Jan 2 15:04:05 -0700 MST 2006_, would be displayed if it were the value. For an alternative way to specify formats check out the [ts_strptime](#ts_strptime) method.
