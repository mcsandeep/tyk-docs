...
The `rate_limit` field can be used to specify a [rate limit]({{< ref "/product-stack/tyk-streaming/configuration/rate-limits/overview" >}}) to cap the rate of requests across all parallel components service wide.
