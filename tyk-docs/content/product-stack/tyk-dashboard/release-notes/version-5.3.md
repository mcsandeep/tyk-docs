...
2. For all deployments - Backup all your API definitions (Tyk OAS API and Classic Definitions):
   ...
   - For Self-Managed deployments -  To perform the backup please use [Tyk Sync]({{<ref "//api-management/automation#synchronize-tyk-environment-with-github-repository" >}}).
