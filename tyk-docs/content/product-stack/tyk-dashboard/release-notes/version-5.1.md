...
[_Tyk Sync_]({{< ref "//api-management/automation#synchronize-tyk-environment-with-github-repository" >}}). We have now extended this feature and it is now possible to do this without
...
- Added a feature to display a full [_Tyk Sync_]({{<ref "//api-management/automation#synchronize-tyk-environment-with-github-repository" >}}) command that will allow a user to import an example UDG into their Dashboard
