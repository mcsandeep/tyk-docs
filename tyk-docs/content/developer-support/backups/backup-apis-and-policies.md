...
If you are using Self Managed deployment then we recommend that you use [Tyk Sync]({{< ref "//api-management/automation#synchronize-tyk-environment-with-github-repository" >}}) to backup your Tyk APIs and policies. 
