...
_Lab Release_ is a release for a product still in the lab phase, during which features are still under active development and testing.
...
## Important information when using products in a _Lab Release_ phase
